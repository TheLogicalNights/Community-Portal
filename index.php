...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="assets/css/style.css">    <!-- SLICK SLIDER  -->
    ...
    <main>        
        <div class="slick-go">
            ...
            <div class="banner" style="background:url(https://images.pexels.com/photos/853168/pexels-photo-853168.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);">
                <div class="hero-text col-lg-5" data-aos="fade-right">
                    <h1>Grow Learn Think Share and Prosper With Us Together</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Non molestiae temporibus voluptatibus fugit eius aut accusamus officia porro aliquam placeat vitae quod, quisquam, magnam quas quaerat voluptatum. Labore, beatae placeat.</p>
                    <a href="/Febina/Members-Portal/signup" class="btn btn-primary">Sign Up</a>
        ...
        </div>    </main>    <footer class="footer-distributed">        <div class="footer-right">
            <a href="#"><span class="mdi mdi-facebook"></span></a>
            <a href="#"><span class="mdi mdi-twitter"></span></a>
            <a href="#"><span class="mdi mdi-linkedin"></span></a>
            <a href="#"><span class="mdi mdi-instagram"></span></a>        </div>        <div class="footer-left">            <p class="footer-links">
                <span class="mdi mdi-facebook-box"></span>
                <a class="link-1" href="#">Home </a>                <a href="#">Blog</a>                <a href="#">Pricing</a>                <a href="#">About</a>                <a href="#">Faq</a>                <a href="#">Contact</a>
            </p>            <p>Febina Community &copy; 2021</p>
        </div>    </footer>    <!-- BOOTSTRAP  -->
